...
GWT_DEV_BASE_URL := http://repo1.maven.org/maven2/com/google/gwt/gwt-dev/$(GWT_DEV_VERSION)
...
GWT_USER_BASE_URL := http://repo1.maven.org/maven2/com/google/gwt/gwt-user/$(GWT_USER_VERSION)
...
GWT_THEME_BASE_URL := http://repo1.maven.org/maven2/net/opentsdb/opentsdb-gwt-theme/$(GWT_THEME_VERSION)
